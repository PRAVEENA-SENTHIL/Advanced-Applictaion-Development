      ...
      <div className="border-b border-white/15 relative overflow-hidden">
        <div className="container mx-auto max-w-[1344px]">
          ...
          >
            ...
            >
              We can take care of the seniors
            </SubHead>
            <Paragraph
              color="text-white/70"
              fontSize="text-sm"
            ...
            >
            Creating a nurturing environment where seniors feel cherished and supported, right at home.
            </Paragraph>
            <MainButton style="w-full sm:w-9/12 sm:w-fit lg:w-fit hover:bg-blue-300 hover:border-white hover:text-white transition-all duration-200 ease-in">
              CONTACT US
            </MainButton>
          </motion.section>
        </div>
