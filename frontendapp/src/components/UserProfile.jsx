  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '100vh', padding: '0 20px' }}>
      <div style={{ maxWidth: '400px', width: '100%', backgroundColor: '#B5C0D0', padding: '40px', borderRadius: '8px', boxShadow: '0px 4px 10px rgba(0, 0, 0, 0.1)' }}>
        <h2 style={{ marginBottom: '20px', textAlign: 'center', fontSize: '1.5rem', fontWeight: 'bold',solor:'#333' }}> User Profile</h2>
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <div>
            <button
              type="submit"
              style={{ width: '100%', padding: '10px', borderRadius: '4px', color: '#fff', fontWeight: 'bold', cursor: 'pointer', border: 'none',backgroundColor: '#272829' }}
            >
            Edit Profile
              </button>
          </div>
