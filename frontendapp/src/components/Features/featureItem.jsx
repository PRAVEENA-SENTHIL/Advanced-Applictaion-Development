...
export default function FeatureItem({ feature, i }) {
  ...
  return (
    ...
    >
      <div className="px-5 py-2.5 flex items-center justify-between border-b border-black-200" style={{backgroundColor:'#0C359E'}}>
        <h4 className="text-white font-body font-medium text-lg">
          {feature?.title}
        </h4>
      </div>
